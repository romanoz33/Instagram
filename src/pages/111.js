...
export default (() => {
	return <Theme theme={theme}>
		...
		<Box padding="0px 50px 0px 50px" display="flex" justify-content="space-around">
			<Components.Instagram urlProp="CIBxZXWIOII" sizeProp="Small" hideCaptionProp width="auto" />
			<Components.Instagram urlProp="CJMctYQoGzq" sizeProp="Small" hideCaptionProp width="auto" />
			<Components.Instagram urlProp="B960wjGobyx" sizeProp="Small" hideCaptionProp width="auto" />
		</Box>
